...
var pontuacaoWrapper = document.getElementById('pontuacao');
var pontuacao = 0;

let btn_subir = document.getElementById("btn_subir");
let btn_descer = document.getElementById("btn_descer");
let btn_atirar = document.getElementById("btn_atirar");
        ...
        aliens.forEach((alien) => { //comparando se cada alien foi atingido, se sim, troca o src da imagem
            if(checkLaserCollision(laser, alien)) {
                ...
                alien.classList.add('dead-alien');
								...
								pontuacaoWrapper.innerHTML = pontuacao;
            }
        })
